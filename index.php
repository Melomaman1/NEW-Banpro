    ...
    <div class="two-col" id="articulos">
      ...
      <aside>
        ...
        <div class="sidebar-card">
          ...
          <ul>
            <li><a href="#">portal de crédito</a></li>
  ...
  <section class="services" id="servicios">
    <div class="container">
      ...
      <div class="services-grid">
        <div class="service-item"><div class="service-icon">🧮</div><h3>portal de crédito</h3><p>Calcula cuota mensual, TEA y costo total de cualquier préstamo en córdobas o dólares.</p></div>
  ...
  <footer id="contacto">
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Herramientas</h5>
          <ul><li><a href="#">portal crédito</a></li><li><a href="#">Comparador bancos</a></li><li><a href="#">Calculadora ahorro</a></li><li><a href="#">Conversor C$/USD</a></li></ul>
        </div>
        <div class="footer-col">
          <h5>Empresa</h5>
